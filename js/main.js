const translations = {
  pt: {
    ...
    'nav.contact':          'Contato',
    'hero.label':           'Tech Lead · Engenheiro de Software',
    ...
    'about.p2':             'Visão de negócio com execução técnica: da prototipagem com IA generativa à gestão de pipelines de CI/CD e infraestrutura em escala e transparência de custos.',
  ...
  en: {
    ...
    'nav.contact':          'Contact',
    'hero.label':           'Tech Lead · Software Engineer',
    ...
    'about.p2':             'Business vision with hands-on execution: from generative AI prototyping to CI/CD pipeline management and scalable and cost-transparent infrastructure.',
